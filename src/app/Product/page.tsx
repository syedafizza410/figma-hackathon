...
const Product = () => {
  // Define state for perPage, sortBy, and view
  const [perPage, setPerPage] = useState(10); // Default perPage value
  const [sortBy, setSortBy] = useState('bestMatch'); // Default sortBy value
  const [view, setView] = useState('grid'); // Default view value
